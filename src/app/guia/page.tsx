      ...
      >
        <div className="max-w-4xl w-full bg-white dark:bg-zinc-900 text-gray-800 dark:text-gray-100 p-8 rounded-lg shadow-lg">
          ...
          <p className="mb-4">
            ...
            Federal para registrar seu pedido de refúgio. Esse pedido é gratuito
            e garante um protocolo oficial, que serve como documento temporário
            válido no país.
          </p>
          ...
          <p className="mb-4">
            ...
            Pessoa Física) e a Carteira de Trabalho (CTPS). Isso permite que
            você trabalhe legalmente, abra conta em banco e utilize diversos
            serviços públicos.
          </p>
          ...
          <p className="mb-4">
            ...
            Adultos também podem estudar por meio da Educação de Jovens e
            Adultos (EJA) e revalidar diplomas do país de origem.
          </p>
          ...
          <p className="mb-4">
            ...
            com abrigo, alimentação, atendimento psicológico, cursos de
            português e orientação jurídica. Procure uma unidade dessas
            instituições na sua cidade.
          </p>
          ...
          <p className="mb-4">
            Aprender o português é um passo essencial para facilitar a
            integração. Muitas ONGs e escolas públicas oferecem aulas gratuitas
          ...
          <p className="mb-4">
            ...
            deportação, igualdade de tratamento, liberdade de ir e vir e acesso
            a serviços públicos. O Brasil é um país signatário da Convenção da
            ONU sobre Refugiados e oferece proteção internacional.
          </p>
          ...
          <p className="mt-8 italic text-sm text-gray-600 dark:text-gray-400">
            ...
            busque órgãos oficiais ou instituições especializadas no atendimento
            a refugiados.
          </p>
        </div>
      </section>
